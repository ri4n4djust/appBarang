...
/* harmony default export */ const __WEBPACK_DEFAULT_EXPORT__ = ({
  ...
  setup: function setup(__props, _ref) {
    ...
    var bind_data = function bind_data() {
      ...
      items.value = store.state.barang; //store.getters.StateBarang;
    };

    var barangs = (0,vue__WEBPACK_IMPORTED_MODULE_0__.computed)(function () {// items.value = store.state.barang;
      // console.log(items)
      // return { barangs }
    });
