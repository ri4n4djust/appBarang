                    ...
                    <div class="custom-table panel-body p-0">
                        ...
                        <v-client-table :data="items" :columns="columns" :options="table_option">
                            ...
                            <template #action_jurnal="props">
                                ...
                                <div v-else>
                                    <!-- {{ itemsjurnal.filter(n => n % props.row.kode_inventaris === 0) }} -->
                                    <div v-for="jr in itemsjurnal" :key="jr">
                                        
                                        <div v-if="jr.rkode_inventaris === props.row.kode_inventaris ">
                                            Sudah  {{ props.row.kode_inventaris }} = {{ jr.rkode_inventaris }}
                                        </div>
                                        <div v-else>
                                            Belum Disusutkan 
                                            <a href="javascript:void(0);" @click="jurnal_row(props.row)" >
