...
--
-- Host: 127.0.0.1
-- Generation Time: Mar 29, 2023 at 06:40 AM
...
(51, 'GJ000025', 'SS0320231', '0', 99999, 1, 'general_ledger', '2023-03-29 00:00:00', '83333.00', 'Penyusutan-Inventaris', 'JK', '01020', 'Comp-Loc', '0', '0', '0', '0', 0, 0, 0, 'user', 'uerr', '2023-03-29 14:37:16', '2023-03-29 14:37:16');
...
(189, 'GJ000025', 12400, '0.00', '83333.00', 'Penyusutan-Inventaris', 0, '2023-03-29 13:37:16', '2023-03-29 13:37:16'),
(190, 'GJ000025', 12503, '83333.00', '0.00', 'Penyusutan-Inventaris', 0, '2023-03-29 13:37:16', '2023-03-29 13:37:16'),
(191, 'GJ000025', 11110, '0.00', '83333.00', 'Penyusutan-Inventaris', 0, '2023-03-29 13:37:16', '2023-03-29 13:37:16'),
(192, 'GJ000025', 61103, '0.00', '83333.00', 'Penyusutan-Inventaris', 0, '2023-03-29 13:37:16', '2023-03-29 13:37:16'),
(193, 'GJ000025', 32300, '0.00', '-83333.00', 'Penyusutan-Inventaris', 0, '2023-03-29 13:37:16', '2023-03-29 13:37:16');
...
CREATE TABLE `tblinventaris` (
  ...
  `accid_akum` varchar(20) COLLATE latin1_general_ci NOT NULL,
...
CREATE TABLE `tblinventaris_penyusutan` (
  ...
  `penyusutan_sysno` varchar(20) COLLATE latin1_general_ci NOT NULL,
...
(11, 'SS0320231', 'SS0320231', '2023-03-29 00:00:00', 'memo', '2023-03-29 05:37:16', '2023-03-29 05:37:16');
...
CREATE TABLE `tblinventaris_penyusutan_detail` (
  ...
  `rsysno_penyusutan` varchar(20) COLLATE latin1_general_ci NOT NULL,
  `rkode_inventaris` varchar(20) CHARACTER SET latin1 COLLATE latin1_general_ci NOT NULL,
  `tgl_penyusutan` datetime NOT NULL,
...
(11, 'SS0320231', 'INV0320231', '2023-03-29 00:00:00', '83333', '2023-03-29 05:37:16', '2023-03-29 05:37:16');
...
--
ALTER TABLE `tblinventaris_penyusutan`
  MODIFY `id_penyusutan` int NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=12;

--
-- AUTO_INCREMENT for table `tblinventaris_penyusutan_detail`
--
ALTER TABLE `tblinventaris_penyusutan_detail`
  MODIFY `id_penyusutan_detail` int NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=12;
