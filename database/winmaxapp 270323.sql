...
--
-- Host: 127.0.0.1
-- Generation Time: Mar 27, 2023 at 01:15 AM
...
CREATE TABLE `tblinventaris` (
  ...
  `kode_inventaris` varchar(20) COLLATE latin1_general_ci NOT NULL,
  `kode_pengadaan` varchar(20) CHARACTER SET latin1 COLLATE latin1_general_ci DEFAULT NULL,
  `nama_inventaris` varchar(225) COLLATE latin1_general_ci NOT NULL,
  `group_inventaris` varchar(20) COLLATE latin1_general_ci NOT NULL,
  ...
  `warna` varchar(150) COLLATE latin1_general_ci NOT NULL,
...
INSERT INTO `tblinventaris` (`id_inventaris`, `kode_inventaris`, `kode_pengadaan`, `nama_inventaris`, `group_inventaris`, `tahun_pembuatan`, `tahun_perakitan`, `merek`, `warna`, `umur_ekonomis`, `created_at`, `updated_at`) VALUES
(1, 'INV0320231', NULL, 'motor', '1', '2020-01-01', '2020-01-02', 'onda', 'hitam', 5, '2023-03-26 04:27:01', '2023-03-26 04:27:01'),
(2, 'INV03202332', NULL, 'mobil', '1', '2010-01-01', '2010-01-01', 'toyota', 'puutih', 10, '2023-03-26 05:16:15', '2023-03-26 05:16:15');
...
CREATE TABLE `tblinventaris_pengadaan` (
  ...
  `pengadaan_sysno` varchar(20) COLLATE latin1_general_ci NOT NULL,
  `pengadaan_docno` varchar(25) COLLATE latin1_general_ci NOT NULL,
  `tgl_spk` date NOT NULL,
  `memo` text COLLATE latin1_general_ci NOT NULL,
  `void_flag` tinyint(1) NOT NULL DEFAULT '0',
  `total` decimal(13,2) NOT NULL,
  `supplier_code` varchar(10) COLLATE latin1_general_ci DEFAULT NULL,
...
(4, 'PGA0320231', 'PGA0320231', '2023-03-27', 'fr', 0, '5596.00', 'SP0001', '2023-03-26 22:14:30', '2023-03-26 22:14:30');
...
CREATE TABLE `tblinventaris_pengadaan_detail` (
  ...
  `rsysno_pengadaan` varchar(20) COLLATE latin1_general_ci NOT NULL,
  `rkode_inventaris` varchar(20) COLLATE latin1_general_ci NOT NULL,
  `rkode_pengadaan` varchar(20) COLLATE latin1_general_ci NOT NULL,
  `kode_pengadaan_detail` varchar(25) COLLATE latin1_general_ci NOT NULL,
...
(1, 'PGA0320231', 'INV0320231', 'PGA0320231', 'PGA0320231INV03202311', '3.00', '4.00', '41.00', '2023-03-26 22:14:30', '2023-03-26 22:14:30'),
(2, 'PGA0320231', 'INV03202332', 'PGA0320231', 'PGA0320231INV032023322', '1.00', '5555.00', '5555.00', '2023-03-26 22:14:30', '2023-03-26 22:14:30');
...
CREATE TABLE `tblinventaris_penyusutan` (
  ...
  `penyusutan_docno` varchar(25) COLLATE latin1_general_ci NOT NULL,
  `tgl_penyusutan` datetime NOT NULL,
  `memo_penyusutan` text COLLATE latin1_general_ci NOT NULL,
  `created_at` timestamp NULL DEFAULT NULL,
  `updated_at` timestamp NULL DEFAULT NULL
) ENGINE=InnoDB DEFAULT CHARSET=latin1 COLLATE=latin1_general_ci;
...
(30, 'PL02022030', 'SURFING', '-', '-', '-', '-', 'user-avtar.svg', '0.00', '2022-08-04 21:42:35', '2022-08-04 21:42:35'),
...
(1, 'BRG0001', 'PERTAMAX', 0, 'Liter', 'KT-2021-1', '11200.00', '0.00', '2023-01-19 22:24:13', '2023-01-19 22:24:13'),
(2, 'BRG0002', 'PERTALITE', 0, 'Liter', 'KT-2021-1', '10200.00', '0.00', '2023-01-19 22:25:23', '2023-01-19 22:25:23'),
(3, 'BRG0003', 'DEX LITE', 0, 'Liter', 'KT-2021-1', '13000.00', '0.00', '2023-01-19 22:26:32', '2023-01-19 22:26:32'),
(4, 'BRG0004', 'GAS ELPIGI 3KG', 0, 'TABUNG', 'KT-2021-3', '0.00', '0.00', '2023-01-20 12:14:45', '2023-01-20 12:14:45'),
(6, 'BRG0005', 'GAS ELPIGI 12KG', 0, 'TABUNG', 'KT-2021-3', '0.00', '0.00', NULL, NULL),
(7, 'BRG0006', 'OLI', 0, 'BOTOL', 'KT-2021-2', '0.00', '0.00', NULL, NULL),
(8, 'BRG0007', 'OLI MESRAN 5L', 0, 'BOTOL', 'KT-2021-2', '0.00', '0.00', NULL, NULL),
...
(3, 'PO0320231', 'BRG0001', 'PERTAMAX', '11200.00', '1000.00', '0.00', '11200000.00', '2023-03-25 11:15:27', '2023-03-25 11:15:27'),
(4, 'PO0320231', 'BRG0002', 'PERLITE', '10200.00', '1000.00', '0.00', '10200000.00', '2023-03-25 11:15:27', '2023-03-25 11:15:27'),
...
--
ALTER TABLE `tblinventaris`
  MODIFY `id_inventaris` int NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=3;

--
-- AUTO_INCREMENT for table `tblinventaris_pengadaan`
--
ALTER TABLE `tblinventaris_pengadaan`
  MODIFY `id_pengadaan` int NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=5;
